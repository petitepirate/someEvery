...
*/
//note that it needs changed to an array first and is compared to a string
...
*/
// check if the first index of a number and the last index of a number are the same
